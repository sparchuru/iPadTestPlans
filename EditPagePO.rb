...
Activate_xpath = "//UIAStaticText[@label='@varData']/following-sibling::UIAButton[@value='1']"
Deactivate_xpath = "//UIAStaticText[@label='@varData']/following-sibling::UIAButton[@value='']"
